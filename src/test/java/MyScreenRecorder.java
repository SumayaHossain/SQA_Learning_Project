...
public class MyScreenRecorder extends ScreenRecorder {
    ...
    public static void startRecording(String methodName) throws  Exception{
        ...
        screenRecorder = new MyScreenRecorder(gc, captureSize, new Format(MediaTypeKey, MediaType.FILE, MimeTypeKey, MIME_AVI),
                new Format(MediaTypeKey, MediaType.VIDEO, EncodingKey, ENCODING_AVI_TECHSMITH_SCREEN_CAPTURE,DepthKey,24,FrameRateKey,
